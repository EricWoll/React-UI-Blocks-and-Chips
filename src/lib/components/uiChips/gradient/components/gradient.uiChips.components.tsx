import {
  ...
  CustomShape,
  ShapePreset,
} from "@/lib/components/uiChips/gradient/types/gradient.uiChips.types";
import { SHAPES } from "@/lib/components/uiChips/gradient/components/shapes.gradient.uiChips.components";
import {
  normalizeAnimations,
  toAnimationCSS,
} from "@/lib/components/uiChips/gradient/utilities/normalize.gradient.uiChips.utilities";
import {
  isValidHex,
  stopsFromHex,
} from "@/lib/components/uiChips/gradient/utilities/color.gradient.uiChips.utilities";
import usePrefersReducedMotion from "@/lib/components/uiChips/gradient/hooks/usePrefersReducedMotion.gradient.uiChips.hooks";
